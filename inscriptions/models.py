...
class Inscrit(models.Model):
	...
	covoiturage = models.BooleanField(True, verbose_name="Vous participez a un système de covoiturage (échanges de numéros téléphone entre participants au stage)")
