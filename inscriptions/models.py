...
class Inscrit(models.Model):
	...
	stage = models.IntegerField(choices = ((60,'Oise'),), verbose_name="Département où vous souhaitez participer")
...
class InscritPerf(models.Model):
	...
	motivation = models.TextField(verbose_name="Qu'est-ce qui motive votre inscription ?")
	...
	stage_cocc_6sept = models.BooleanField(verbose_name="stage et journée d’études Coccinelles")
