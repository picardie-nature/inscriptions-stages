...
class Inscrit(models.Model):
	...
	covoiturage = models.BooleanField(verbose_name="Souhaitez-vous participer a un système de covoiturage (échange de numéro téléphone entre participants au stage) ?")
